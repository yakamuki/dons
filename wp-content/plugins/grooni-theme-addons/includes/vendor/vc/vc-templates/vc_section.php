...
$ct_section_stretch = isset( $atts['ct_section_stretch'] ) ? $atts['ct_section_stretch'] : '';

switch ( $ct_section_stretch ) {
	case 'stretch_section_content':
		$containerClass = ' crane-container-fluid';
		break;
	case 'stretch_section_content_no_spaces':
		$containerClass = ' crane-container-fluid crane-container--no-padding';
		break;
	case 'stretch_section':
...
$wrapper_attributes[] = 'class="' . esc_attr( trim( $css_class ) ) . $containerClass . '"';


if ( ! $ct_section_stretch ) { // default
