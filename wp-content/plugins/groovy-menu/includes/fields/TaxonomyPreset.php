...
/**
 * Class GroovyMenuFieldTaxonomyPreset
 */
class GroovyMenuFieldTaxonomyPreset extends GroovyMenuFieldField {
	...
	public function renderField() {
		...
		$presets     = $default_arr + GroovyMenuPreset::getAll( true );
		$default     =
					...
					<div class="gm-gui__subselect-wrapper--left">
						...
						<select data-default="<?php echo esc_attr( $default['preset'] ); ?>"
							...
							<?php foreach ( $presets as $key => $name ) { ?>
								<option value="<?php echo esc_attr( $key ); ?>"<?php echo ( isset( $saved_tax[ $type_name ]['preset'] ) && strval( $saved_tax[ $type_name ]['preset'] ) === strval( $key ) ) ? 'selected' : ''; ?>><?php echo esc_html( $name ); ?></option>
							<?php } ?>
						</select>
					</div>
					...
					<div class="gm-gui__subselect-wrapper--right">
						...
						<select data-default="<?php echo esc_attr( $default['menu'] ); ?>"
							...
							<?php foreach ( $nav_menus as $key => $name ) { ?>
								<option value="<?php echo esc_attr( $key ); ?>"<?php echo ( isset( $saved_tax[ $type_name ]['menu'] ) && strval( $saved_tax[ $type_name ]['menu'] ) === strval( $key ) ) ? 'selected' : ''; ?>><?php echo esc_html( $name ); ?></option>
							<?php } ?>
						</select>
					</div>
