...
class GM_Migration {
	...
	private static $migrate_version_points = array(
		'1.1.4'       => [ 'type' => 'ask' ],
		'1.1.8'       => [ 'type' => 'ask' ], // correct mobile_offcanvas_width.
		'1.2.15.260'  => [ 'type' => 'ask' ], // copy preset options 'sticky_(header|offset)' to 'sticky_(header|offset)_mobile'.
		'1.2.15.289'  => [ 'type' => 'ask' ], // correct invert mega_menu_show_links_bottom_border.
		'1.2.15.297'  => [ 'type' => 'ask' ], // save thumb local instead save in base64 option.
		'1.3.0.353'   => [ 'type' => 'ask' ], // change presets settings for mobile version.
		'1.3.0.353.2' => [ 'type' => 'ask' ], // change presets settings for mobile version.
		'1.3.0.353.3' => [ 'type' => 'ask' ], // rename options from [mobile_type] to [minimalistic_menu_open_type].
		'1.3.0.353.4' => [ 'type' => 'ask' ], // change presets settings for mobile version.
		'1.4.4.400.1' => [ 'type' => 'ask' ], // move presets to [groovy_menu_preset] custom post type.
		'1.4.4.400.2' => [ 'type' => 'ask' ], // change old preset id to new.
		'1.4.4.403'   => [ 'type' => 'ask' ], // cleanup for 1.4.4.40X migrations.
		'1.5.4.520'   => [ 'type' => 'ask' ], // intval() for some fields of preset settings.
		'1.5.5.529'   => [ 'type' => 'ask' ], // gm_menu_blocks as self post types for appearance->menus.
		'1.5.6.559'   => [ 'type' => 'ask' ], // set doNotShowTitle is title just '-' text.
		'1.5.6.575'   => [ 'type' => 'ask' ], // copy default master nav_menu from global to menu location gm_primary.
	);
	...
	public function __construct() {
		...
		if ( class_exists( 'GM_DebugPage' ) ) {
			GM_DebugPage::get_instance()->createPage();
		}
