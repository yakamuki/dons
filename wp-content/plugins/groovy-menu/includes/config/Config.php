...
return array(
	'general' => array(
		...
		'fields' => array(
			...
			'show_wpml'                                    => array(
				'title'       => 'Toggle switch to show/hide WPML language switcher',
				'description' => '',
				'type'        => 'checkbox',
				'default'     => false,
			),
			...
			'sub_level_background_color'                   => array(
				'title'   => esc_html__( 'Submenu and minicart background color', 'groovy-menu' ),
				'type'    => 'colorpicker',
				'default' => '#202022',
				'alpha'   => true,
			),
	...
	'styles'  => array(
		...
		'fields' => array(
			...
			'woo_cart_dropdown_product_name_color'      => array(
				'title'   => esc_html__( 'Product name color', 'groovy-menu' ),
				'type'    => 'colorpicker',
				'default' => '#ffffff',
				'alpha'   => true,
			),
