...
if ( ! class_exists( 'ReduxFramework_extension_crane_add_image_sizes' ) ) {

	/**
	 * Groovy menu plugin extension class for ReduxFramework
	 */
	class ReduxFramework_extension_crane_add_image_sizes extends ReduxFramework {
		...
		public function __construct( $parent ) {
			...
			$this->field_name = 'crane_add_image_sizes';
