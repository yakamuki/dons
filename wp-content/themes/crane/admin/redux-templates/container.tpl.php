...
<div class="redux-container<?php echo esc_attr( $expanded ); ?>">
	...
	<form method="post"
		...
		<input type="hidden" id="redux-compiler-hook"
		       name="<?php echo esc_attr( $opt_name ); ?>[compiler]"
		       value=""/>
		<input type="hidden" id="currentSection"
		       name="<?php echo esc_attr( $opt_name ); ?>[redux-section]"
		       value=""/>
		<?php if ( ! empty( $this->parent->no_panel ) ) { ?>
			<input type="hidden"
			       name="<?php echo esc_attr( $opt_name ); ?>[redux-no_panel]"
		...
		<input type="hidden"
		       id="last_tab"
		       name="<?php echo esc_attr( $opt_name ); ?>[last_tab]"
